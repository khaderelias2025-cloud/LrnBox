...
export interface QuizContent {
  ...
  crosswordWords?: CrosswordWord[]; // For crossword game
}

export interface AssessmentQuestion {
  id: string;
  type: QuizType;
  question: string; // Fallback / Original
  question_en?: string;
  question_ar?: string;
  options?: string[]; // Fallback / Original
  options_en?: string[];
  options_ar?: string[];
  correctAnswer: any;
  feedback?: string; // Fallback / Original
  feedback_en?: string;
  feedback_ar?: string;
...
export interface Lesson {
  ...
  videoUrl?: string;
  imageUrl?: string;
  imageExplanation?: string; // Added field for optional image explanation
  audioUrl?: string;
  html5Url?: string;
...
export interface Message {
  ...
  reactions?: Record<string, number>; // e.g. { '👍': 1, '❤️': 2 }
